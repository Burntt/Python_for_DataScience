...
class Exp1_1Classifier(BaseEstimator, ClassifierMixin):
    ...
    def feature_transformation(self, train_df):
        ...
        numeric_features_sudataset = train_df[  ['HP', 'Attack','Defense', 'Sp_Atk', 'Sp_Def', 'Speed'] ]
        numeric_features_sudataset

        preprocessor_exp_1_1 = preprocessing.PolynomialFeatures(degree = 4)
    ...
    def fit(self, train_df):
        ...
        self.fit_classifier = self.classifier.fit(transformed_features, train_df['HighStage'])
